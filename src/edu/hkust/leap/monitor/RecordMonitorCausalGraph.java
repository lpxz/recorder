...
public class RecordMonitorCausalGraph {
...
//	}
    ...
    public static void readBeforeArrayElem(Object o, int index, long tid, String classname , int lineNO, int arrayindex) {
    ...
    public static void writeBeforeArrayElem(Object o, int index, long tid, String classname , int lineNO, int arrayindex)
    {
    	SharedAccessEvent e = new SharedAccessEvent(Thread.currentThread().getId(), cg.getMemoryManager().getMemID(o, index));
        cg.addVertex_complete(e); 
        e.setClassname(classname);
    ...
    public static void readBeforeInstance(Object o, int index, long tid,String classname , int lineNO) {
    	SharedAccessEvent e = new SharedAccessEvent(Thread.currentThread().getId(), cg.getMemoryManager().getMemID(o, index));
        cg.addVertex_complete(e); 
        e.setClassname(classname);
        e.setLineNO(lineNO);
    ...
    public static void writeBeforeInstance(Object o, int index, long tid,String classname , int lineNO)
    {
    	SharedAccessEvent e = new SharedAccessEvent(Thread.currentThread().getId(), cg.getMemoryManager().getMemID(o, index));
        cg.addVertex_complete(e); 
        e.setClassname(classname);
    ...
    public static void readBeforeFakedInstance(Object o, int index, long tid, String classname , int lineNO) {
    	SharedAccessEvent e = new SharedAccessEvent(Thread.currentThread().getId(), cg.getMemoryManager().getMemID(o, index));
        cg.addVertex_complete(e); 
        e.setClassname(classname);
        e.setLineNO(lineNO);
    ...
    public static void writeBeforeFakedInstance(Object o, int index, long tid, String classname , int lineNO)
    {
    	SharedAccessEvent e = new SharedAccessEvent(Thread.currentThread().getId(), cg.getMemoryManager().getMemID(o, index));
        cg.addVertex_complete(e); 
        e.setClassname(classname);
    ...
    public static void readBeforeStatic(int index,long tid, String classname , int lineNO) {
    ...
    public static void writeBeforeStatic(int index,long tid,String classname , int lineNO) {
    	SharedAccessEvent e = new SharedAccessEvent(Thread.currentThread().getId(), cg.getMemoryManager().getMemID( index));
        cg.addVertex_complete(e); 
        e.setClassname(classname);
        e.setLineNO(lineNO);
